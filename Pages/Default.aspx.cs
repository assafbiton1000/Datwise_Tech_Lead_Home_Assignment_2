...
namespace Datwise_Tech_Lead_Home_Assignment.Pages
{
    public partial class Default : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                lblWelcome.Text = "שלום, " + (User.Identity.IsAuthenticated ? User.Identity.Name : "אורח");
                LoadKPIs();
            }
        }
        ...
        ");
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblSum.Text = dt.Rows[0]["TotalSum"] != DBNull.Value ? string.Format("{0:N2}", dt.Rows[0]["TotalSum"]) : "0.00";
            }
